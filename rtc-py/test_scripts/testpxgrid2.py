...
def main(argv):
    ...
    try:
        ...
        PXGRID_NODENAME = "kallekula"

        debug = True

        i = cats.ISE_PXGRID2(server=ISE_SERVER,username=ISE_USERNAME,password=ISE_PASSWORD,debug=debug,logfile="",nodename=PXGRID_NODENAME)
    except Exception as err:
        print("bajs")
